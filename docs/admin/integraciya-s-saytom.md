# Интеграция сайта с Lead CRM (тестирование)
...
| Что | Где |
|-----|-----|
| CRM (production) | https://lk.crm-lead.ru |
| Админка | https://lk.crm-lead.ru/admin/ |
| Endpoint приёма заявок | `https://lk.crm-lead.ru/ingest/seolead` |
...
### Вариант A — Конструкторы сайтов (без lead.php на сервере)
...
4. Замените в сниппете:
   - `INGEST_URL` → `https://lk.crm-lead.ru/ingest/seolead`
