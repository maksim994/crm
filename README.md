...
**Навигация в ЛК:** общий раздел **Лиды** (`/cabinet/`) и подразделы по каждому проекту — **Лиды и продажи**, **Трафик и лиды** (заглушка). Подробнее: [docs/lichnyj-kabinet.md](docs/lichnyj-kabinet.md).
